    ...
    <nav className={`backdrop-blur bg-white/70 supports-backdrop:bg-white/60 border-b border-slate-200 ${isScrolled ? 'shadow-md' : ''}`}>
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          <Link href="/" className="flex items-center gap-2 group" aria-label="RasuTech Consulting Home">
          ...
          <div className="hidden md:flex items-center gap-3">
            <Link
              href="/login"  className="inline-flex items-center justify-center px-4 py-2 rounded-md bg-gradient-to-r from-indigo-600 to-cyan-500 text-white shadow hover:shadow-lg transition-shadow">
              Login
            </Link>
          </div>

                    ...
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-gutter">
                        ...
                        <div
                            ...
                            <div className="md:w-1/3">
                                ...
                                <h3 className="font-headline-md text-headline-md text-primary mb-4">{siteConfig.shortName} Global</h3>
                            ...
                            <div className="md:w-2/3 grid grid-cols-2 md:grid-cols-4 gap-8">
                                <div className="text-center">
                                    <p className="font-display-lg text-headline-xl text-primary">
                    ...
                    <div className="flex flex-col gap-16">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                            <div className="glass-card p-10 rounded-[40px] transition-all duration-500 hover:-translate-y-2 group">
                                ...
                                <p className="font-display-lg text-headline-xl text-primary mb-1">
                                    <AnimatedCounter end="500+" />
                                </p>
                    ...
                    <div className="max-w-container-max mx-auto">
                        <div className="flex flex-col md:flex-row gap-24 items-start">
                            <div className="md:w-1/2 sticky top-48">
                                ...
                                <p className="font-body-lg text-body-lg text-primary-fixed mb-12">Our consulting isn't a
                            ...
                            <div className="md:w-1/2 relative">
                                ...
                                <div className="space-y-24">
                                    ...
                                    <div className="relative pl-16 group">
                                        ...
                                        <p className="text-body-md text-primary-fixed">We begin with a forensic audit of
                                    ...
                                    <div className="relative pl-16 group">
                                        ...
                                        <p className="text-body-md text-primary-fixed">Custom engineering of solutions that
                                    ...
                                    <div className="relative pl-16 group">
                                        ...
                                        <p className="text-body-md text-primary-fixed">Embedding our mentorship protocol into
                                    ...
                                    <div className="relative pl-16 group">
                                        ...
                                        <p className="text-body-md text-primary-fixed">Continuous architectural oversight and

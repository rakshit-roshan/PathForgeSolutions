...
export default function Page() {
  return (
    ...
    <section
        className="py-section-gap bg-primary text-white rounded-[64px] mx-4 md:mx-10 px-margin-mobile md:px-margin-desktop">
        <div className="max-w-container-max mx-auto">
            <div className="mb-20">
                <span className="text-label-md font-label-md text-secondary-fixed mb-4 inline-block">STRATEGIC
                    PLANNING</span>
                <h2 className="text-headline-xl font-headline-xl mb-6">The PathForge Roadmap</h2>

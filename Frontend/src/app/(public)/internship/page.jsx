...
export default function Page() {
  return (
        ...
        <div className="relative z-10 grid lg:grid-cols-2 gap-gutter items-center">
            <div>
                ...
                <h1 className="font-display-lg text-display-lg text-primary mb-6 leading-tight">
                    Industry Experience <br /><span className="text-on-primary-container">Accelerator.</span>
                </h1>
                ...
                <div className="flex flex-wrap gap-4">
                    <button
                        className="bg-primary-container text-white px-8 py-4 rounded-xl font-label-md flex items-center gap-2 hover:translate-y-[-2px] transition-all">
                        Apply for Accelerator
                        <span className="material-symbols-outlined" data-icon="arrow_forward">arrow_forward</span>
                    </button>
                    <button
                        className="glass-card px-8 py-4 rounded-xl font-label-md text-primary border border-primary/10 hover:bg-white transition-all">
                        Download Roadmap
                    </button>
                </div>
            </div>
            <div className="relative">
                <div className="glass-card p-6 rounded-[32px] ambient-shadow relative overflow-hidden max-h-[360px]">
                    <img alt="Tech Mentorship" className="w-full h-[360px] object-cover rounded-[24px]"
                    ...
                    <div
                        className="absolute bottom-12 right-12 glass-card p-6 rounded-2xl border border-white/40 shadow-xl">
    ...
    {/*  Track Grid Section  */}
    <section
        className="py-section-gap px-margin-desktop max-w-container-max mx-auto bg-surface-container-low rounded-[64px]">
        <div className="text-center mb-20">
            <h2 className="font-headline-xl text-headline-xl text-primary mb-4">Engineering Specializations</h2>
            <p className="text-body-md text-on-surface-variant max-w-2xl mx-auto">Selected candidates choose a specialized
                track mentored by senior architects from PathForge’s core solutions team.</p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="glass-card p-12 rounded-[48px] hover:scale-[1.02] transition-all group">
                ...
                <p className="text-body-sm text-on-surface-variant mb-8">Architecting end-to-end resilient systems using
                    Next.js, Go, and PostgreSQL. Focus on performance and DX.</p>
            ...
            <div className="glass-card p-12 rounded-[48px] hover:scale-[1.02] transition-all group">
                ...
                <p className="text-body-sm text-on-surface-variant mb-8">Deploying LLMs and generative models at scale.
                    Focus on data pipelines, fine-tuning, and inference latency.</p>
                <div className="space-y-4 mb-10">
                    <div className="flex items-center gap-3">
                        <span className="material-symbols-outlined text-on-primary-container text-sm"
                            data-icon="verified">verified</span>
            ...
            <div className="glass-card p-12 rounded-[48px] hover:scale-[1.02] transition-all group">
                ...
                <p className="text-body-sm text-on-surface-variant mb-8">Mastering Architectural Glassmorphism and
                    systematic UI patterns. Focus on accessibility and executive aesthetics.</p>
                <div className="space-y-4 mb-10">
                    <div className="flex items-center gap-3">
                        <span className="material-symbols-outlined text-on-primary-container text-sm"
                            data-icon="verified">verified</span>
    ...
    <section className="py-section-gap px-margin-desktop max-w-container-max mx-auto">
        <div className="grid lg:grid-cols-12 gap-gutter">
            <div className="lg:col-span-4">
                ...
                <p className="text-body-md text-on-surface-variant mb-8">Interns are not students here; they are junior
                    consultants assigned to specific mission pods. You operate within a structure designed for rapid
                ...
                <div className="space-y-8 relative pl-12">
                    ...
                    <div className="relative">
                        <div
                            className="absolute -left-10 w-6 h-6 rounded-full bg-primary border-4 border-surface shadow-[0_0_15px_rgba(10,33,86,0.3)]">
                        </div>
                        <h4 className="font-label-md text-primary uppercase">Principal Architect</h4>
                        <p className="text-body-sm text-on-surface-variant">Strategic oversight and architectural review
                            once a week.</p>
                    </div>
                    <div className="relative">
                        <div
                            className="absolute -left-10 w-6 h-6 rounded-full bg-primary-fixed-dim border-4 border-surface shadow-[0_0_15px_rgba(180,197,255,0.3)]">
                        </div>
                        <h4 className="font-label-md text-primary uppercase">Senior Mentor</h4>
                        <p className="text-body-sm text-on-surface-variant">Daily code reviews, pair programming, and
                            blocker resolution.</p>
                    </div>
                    <div className="relative">
                        <div
                            className="absolute -left-10 w-6 h-6 rounded-full bg-secondary-fixed-dim border-4 border-surface shadow-[0_0_15px_rgba(178,197,255,0.3)]">
                        </div>
                        <h4 className="font-label-md text-primary uppercase">The Pod (Intern Team)</h4>
                        <p className="text-body-sm text-on-surface-variant">3-5 specialists working together on a live
                ...
                <div className="glass-card p-12 rounded-[64px] ambient-shadow">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                        <div className="space-y-4">
                            ...
                            <p className="text-body-sm text-on-surface-variant">Weeks 1-2: Immersion into PathForge tech
                                stack, tooling, and culture.</p>
                        </div>
                        <div className="space-y-4">
                            ...
                            <p className="text-body-sm text-on-surface-variant">Weeks 3-6: Joining active projects as a
                                junior contributor.</p>
                        </div>
                        <div className="space-y-4">
                            ...
                            <p className="text-body-sm text-on-surface-variant">Weeks 7-10: Leading a specific sub-feature
                                or technical optimization.</p>
                        </div>
                        <div className="space-y-4">
                            ...
                            <p className="text-body-sm text-on-surface-variant">Weeks 11-12: Final architectural review,
                                certification, and hiring decisions.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section className="py-section-gap px-margin-desktop max-w-container-max mx-auto">
        <div className="grid lg:grid-cols-3 grid-rows-2 gap-8 h-auto lg:h-[700px]">
            <div
                className="lg:col-span-2 glass-card p-16 rounded-[64px] flex flex-col justify-between overflow-hidden relative">
                <div className="relative z-10">
                    <h2 className="font-display-lg text-headline-xl text-primary mb-8">PathForge Certified Architect</h2>
                    <p className="text-body-lg text-on-surface-variant max-w-xl">
                        Our certification isn't a digital badge. It's a validated portfolio of enterprise code and a
                        recommendation from the industry's elite architects.
                    </p>
                </div>
                <div className="flex gap-4 relative z-10 mt-12">
                    <button className="bg-primary text-white px-8 py-4 rounded-xl font-label-md">Review Curriculum</button>
                    <button className="bg-surface-container text-primary px-8 py-4 rounded-xl font-label-md">View Sample
                        Portfolio</button>
                </div>
                <img alt="Certification Design"
            ...
            <div className="bg-primary p-12 rounded-[64px] text-white flex flex-col justify-center">
                ...
                <p className="text-body-sm opacity-80">Interns who complete the accelerator are offered full-time roles or
                    placed in our partner ecosystem.</p>
            </div>
            <div className="glass-card p-12 rounded-[64px] border-2 border-primary/5 flex flex-col justify-between">
                <div className="space-y-6">
                    ...
                    <p className="text-body-sm text-on-surface-variant">Validated against international enterprise
